package com.example.practica2dialogosynotificaciones;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button registrosExpo = (Button) findViewById(R.id.btnVerRegistrosExpo);
        ...
        Button registrosAsist = (Button) findViewById(R.id.btnVerRegistrosAsist);
        ...
        Button borrarDatosSalir = (Button) findViewById(R.id.btnBorrarDatos);
    ...
    private void MostrarFormularioExpositor() {
        AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this);
        LayoutInflater inflater = getLayoutInflater();
        View view = inflater.inflate(R.layout.formulario_expositor, null);
        builder.setView(view);
    ...
    private void MostrarFormularioAsistente() {
        AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this);
        LayoutInflater inflater = getLayoutInflater();
        View view = inflater.inflate(R.layout.formulario_asistente, null);
        builder.setView(view);
        builder.setCancelable(false); // Evita que el diálogo se cierre al hacer clic fuera de él
        AlertDialog dialog = builder.create();
        dialog.show();
    ...
    private void verRegistrosExpo(){
        ...
        LayoutInflater inflater = getLayoutInflater();
        View toastView = inflater.inflate(R.layout.toast_personalizado, null);
